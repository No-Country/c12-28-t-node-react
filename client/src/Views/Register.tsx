...
export default function Register() {
  const [clic, setClic] = useState<boolean>(true)
    ...
    <>
      <NavBar />
      {
        clic ? (
            ...
            <div className="rounded-sm flex flex-col justify-center items-center ">
              ...
              <div className="bg-white-color px-14 py-8 flex flex-col gap-6 items-center justify-center rounded-b-[15px] shadow-sm">
                ...
                <div className="flex flex-col justify-center item-center gap-2">
                  ...
                  <button onClick={() => setClic(false)} className="bg-tertiary-color rounded-full p-2 text-lg text-white">
                    Aceptar
                  </button>
                </div>
              </div>
          ...
          <RegisterCompleted  message={"¡Felicidades te has registrado satisfactoriamente! Por favor revisa tu correo para confirmar."}/>
        )
      }
      <Footer />
    </>
